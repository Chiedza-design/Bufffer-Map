...
var style_CHINHOYICAVES_23 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var labelFont = "9.1px \'Nirmala Text\', sans-serif";
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 6.4 + size, points: 3,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(255,255,255,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(107,43,138,1.0)'})}),
