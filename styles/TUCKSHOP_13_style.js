...
var style_TUCKSHOP_13 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (feature.get("ID_1") !== null) {
            labelText = String(feature.get("ID_1"));
        }
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 2.8 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(50,87,128,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(241,221,22,1.0)'})}),
